...
class Session(SessionData):
    ...
    def set(self,name,value,timeout = None):
        self.session_manager.setex(name,value,timeout)


    def replace(self,name,value,timeout = None):
        self.set(name,value,timeout)

    # def get(self,key):
    #     return self.session_manager.get(ex)
class SessionManager(object):
    ...
    def setex(self,name,value,timeout = None):
        timeout = timeout if timeout else self.session_timeout
        self.redis.setex(name, timeout, value)
